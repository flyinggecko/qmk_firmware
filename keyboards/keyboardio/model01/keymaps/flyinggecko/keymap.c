...
[WORKMAN] = LAYOUT(
  ...
  KC_TAB , KC_Q   , KC_D   , KC_R   , KC_W   , KC_B   , _______,    _______, KC_J   , KC_F   , KC_U   , KC_P   , KC_SCLN, KC_EQL ,
...
[FUN] = LAYOUT(
  ...
  KC_HOME, _______, KC_MS_U, KC_WH_U, KC_BTN2, _______, _______,    KC_MPRV, KC_MNXT, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_F12 ,
